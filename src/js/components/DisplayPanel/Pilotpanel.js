...
export default class Pilotpanel extends React.Component {
...
var SHData = [
    [{name:'上海'},{name:'哈尔滨',value:95}],
    [{name:'上海'},{name:'抚远',value:90}],
    [{name:'上海'},{name:'长春',value:80}],
    [{name:'上海'},{name:'呼和浩特',value:70}],
    [{name:'上海'},{name:'银川',value:60}],
    [{name:'上海'},{name:'西安',value:50}],
    [{name:'上海'},{name:'成都',value:40}],
    [{name:'上海'},{name:'南宁',value:30}],
    [{name:'上海'},{name:'桂林',value:20}],
    [{name:'上海'},{name:'海口',value:10}],
    [{name:'上海'},{name:'昆明',value:30}],
    [{name:'上海'},{name:'广州',value:20}],
    [{name:'上海'},{name:'福州',value:10}],
    [{name:'上海'},{name:'深圳',value:10}]
...
var option = {
    ...
    return (
        ...
        <Card title="飞行图" extra={<Icon type="cross" onClick={this.RemoveCard.bind(this)} />}>
